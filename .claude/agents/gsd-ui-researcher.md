...
Use template from `/Users/gabriel/projets/symfony-template/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/gabriel/projets/symfony-template/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/gabriel/projets/symfony-template/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
