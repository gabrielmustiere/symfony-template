...
- **Global scope**: `/Users/gabriel/projets/symfony-template/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/gabriel/projets/symfony-template/.claude/notes/`)
...
2. Glob `/Users/gabriel/projets/symfony-template/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/gabriel/projets/symfony-template/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/gabriel/projets/symfony-template/.claude/notes/` — works in any directory
